...
class CustomIconPicker extends Select
{
    use CanBeCacheable;
    ...
    protected function setUp(): void
    {
        ...
        $this->getSearchResultsUsing = function (CustomIconPicker $component, string $search, Collection $icons) {
        ...
        $this->getOptionLabelUsing = function (CustomIconPicker $component, $value) {
            if ($value) {
        ...
        $this
            ->itemTemplate(function (CustomIconPicker $component, string $icon) {
