...
namespace App\Filament\Resources\HeaderImage\Exports;
...
class Exporter extends BaseExporter
{
    ...
    {
        $body = 'Your header image export has completed and ' . number_format($export->successful_rows) . ' ' . str('row')->plural($export->successful_rows) . ' exported.';
