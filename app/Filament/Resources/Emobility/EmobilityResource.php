...
namespace App\Filament\Resources\Emobility;

use App\Classes\CustomPackage\CustomComponent\CustomCuratorPicker;
use App\Classes\FilamentUtility;
use App\Filament\Resources\Emobility\Exports\Exporter;
use App\Filament\Resources\Emobility\Model\Emobility;
use App\Filament\Resources\Emobility\ResourcePages\Create;
use App\Filament\Resources\Emobility\ResourcePages\Edit;
use App\Filament\Resources\Emobility\ResourcePages\ListItems;
...
class EmobilityResource extends Resource
{
                    ...
                    Grid::make(3)->schema([
                        ...
                        Section::make()
                            ...
                            ->schema([
                                ...
                                FilamentUtility::seoSection($tab, '/emobility/'),
                                // FilamentUtility::headerImageSection($tab, '/emobility/'),
                            ]),
                    ]),
                ]),
        ]);
