...
namespace App\Filament\Resources\VideoGallery\Policy;
...
class VideoGalleryPolicy
{
     ...
     */
    public function view(User $user, VideoGallery $postCategory): bool
    {
     ...
     */
    public function update(User $user, VideoGallery $postCategory): bool
    {
     ...
     */
    public function delete(User $user, VideoGallery $postCategory): bool
    {
     ...
     */
    public function forceDelete(User $user, VideoGallery $postCategory): bool
    {
     ...
     */
    public function restore(User $user, VideoGallery $postCategory): bool
    {
     ...
     */
    public function replicate(User $user, VideoGallery $postCategory): bool
    {
