        ...
        >
            ...
            <span class="opacity-100">
                @if (isset($currentLanguage) && $showFlags)
                    ...
                    <img class="pl dark:invert" width="25px" src="{{asset('/images/vendor/'.$currentLanguage['code'].'.svg')}}" />
                @else
                    <x-icon
                ...
                >
                    <span class="filament-dropdown-list-item-label truncate w-full text-start flex justify-content-start gap-3">
                        @if ($showFlags)
                            ...
                            <img class="pl dark:invert" width="25px" src="{{asset('/images/vendor/'.$language['code'].'.svg')}}" />
