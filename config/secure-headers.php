<?php
    ...
    if( php_sapi_name() != "cli" ) //cmd
    {
        if( !str_contains(env("FILAMENT_ADMIN_PANEL_PATH"), request()->fullUrl() ) )
        {
            return [
                ...
                */
                ...
                'csp' => [
                    ...
                    'script-src' => [
                        ...
                        // strict-dynamic requires nonces; disabled so self + allow + unsafe-inline apply
